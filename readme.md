# IntroAI course project: Search & Nature-Inspired Algorithms

Testing and comparing different heuristic-based and swarms intelligence algorithm across multiple target functions and optimization problems:
...
- Pathfinding problems: Navigating grids using traditional search.
...
- Core algorithms:
  ...
  - Pathfinding (BFS, DFS, A*): [algo/graph_search.py](algo/graph_search.py)
- Swarm algorithms:
